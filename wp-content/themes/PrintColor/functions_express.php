<?php
    ...
    $message  =  '<b>СРОЧНЫЙ Заказ (ФОТООБОИ):</b>' . '<br /><br />';
    ...
    mail('printcolor45@gmail.com', 'СРОЧНЫЙ заказ на фотообои ('. $_POST["username"] .')', $message, $headers);
    mail('printcolor-45@yandex.ru', 'СРОЧНЫЙ заказ на фотообои ('. $_POST["username"] .')', $message, $headers);
    ...
    $message2 .=  '<b>Наш менеджер свяжется с вами в ближайшее время для уточнения деталей заказа.</b>' . '<br /><br />';
    ...
    mail( $_POST["mail"], 'Срочный заказ - фотообои PrintColor', $message2, $headers2);
