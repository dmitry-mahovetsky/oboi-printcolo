...
function wp_cumulus_createflashcode($widget){
	...
	$flashtag .= '</p><p>Облако тегов плагина WP Cumulus (<a href="http://www.wordpressplugins.ru/">русская версия плагина</a>) требует для просмотра <noindex><a href="http://www.adobe.com/go/getflashplayer" target="_blank" rel="nofollow">Flash Player 9</a></noindex> или выше.</p></div>';
